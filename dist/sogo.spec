...
BuildRequires: sope%{sope_major_version}%{sope_minor_version}-appserver-devel
BuildRequires: sope%{sope_major_version}%{sope_minor_version}-core-devel
BuildRequires: sope%{sope_major_version}%{sope_minor_version}-gdl1-devel
BuildRequires: sope%{sope_major_version}%{sope_minor_version}-ldap-devel
